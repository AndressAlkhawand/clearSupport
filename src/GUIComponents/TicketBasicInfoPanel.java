...
public class TicketBasicInfoPanel  extends JPanel {
	...
	private JComboBox<Impact> impCombo;

	private JLabel prLabel; //Priority
	private JComboBox<Priority> prCombo;
	...
	/**
	 * Gets the ticket ID from the ticket ID text field
	 * @return the ticket ID from the ticket ID text field
	 */
	public int getID()
	{
