...
public class HWTicketDisplayPanel extends TicketDisplayPanel {
	...
	protected void initSpecialComps() {
		...
		hwTypeLabel = new JLabel("Hardware Type: ");
		hwTypeTF = new JTextField(15);

		manufacturerLabel = new JLabel("Manufacturer: ");
		manufacturerTF = new JTextField(15);

		pnLabel = new JLabel("Product Number: ");
		pnTF = new JTextField(15);
		
		snLabel = new JLabel("Serial Number: ");
		snTF = new JTextField(15);

		specialPanel = new JPanel(new GridLayout(4,2));

		specialPanel.add(hwTypeLabel);
		specialPanel.add(hwTypeTF);
		specialPanel.add(manufacturerLabel);
		specialPanel.add(manufacturerTF);
		specialPanel.add(pnLabel);
		specialPanel.add(pnTF);
		specialPanel.add(snLabel);
	...
	protected void setUpSubmitButton() {
		...
		if (empUsingPanelRole == LogonRole.USER)
		{
			...
			submitBtn.addActionListener(new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent e) {
					...
					else if (manufacturerTF.getText().equals(""))
						s = "Please include a Manufacturer.";
		...
		else if (empUsingPanelRole == LogonRole.SUPERVISOR)
		{
			submitBtn.addActionListener(new ActionListener()
			{
				@Override
	...
	protected void setSpecialCompsForViewingOldTickets(Ticket ticket, boolean isEditable) {
		...
		//Add HW, OS, Bits Components
		hwTypeTF.setText(hwTicket.getHardwareType());
		manufacturerTF.setText(hwTicket.getManufacturer());
