...
public class TicketCreatorPanel extends JPanel{
	...
	private void initComps(Employee emp)
	{
		...
		setBorder(BorderFactory.createTitledBorder("Employee Info"));
	...
	/**
	 * Gets the employee ID from the employee ID text field
	 * @return the employee ID from the employee ID text field
	 */
	public int getID()
	{
