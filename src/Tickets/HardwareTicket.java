...
public class HardwareTicket extends Ticket 
{
	 ...
	 */
	public HardwareTicket(int id, Employee c, String inc, Priority p, Impact imp, Technician o, String dOp, String dCl, String clNotes, boolean isO, ArrayList <String> tNotes, ArrayList <String> uNotes,
			String type, String m, String proNum, String serialNum) {
