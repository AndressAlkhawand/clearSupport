...
public class Ticket implements Serializable {
	...
	public Ticket(int id, Employee c, String inc, Priority p, Impact imp, Technician o, 
			String dOp, String dCl, String clNotes, boolean isO, ArrayList<String> tNotes, ArrayList<String> uNotes) {
	 ...
	 * @param pr the priority of the ticket
	 */
	...
	/**
	 * Sets the impact of the incidence
	 * @param imp The impact of the incidence
	 */
	public void setImpact(Impact imp)
	{
		impact = imp;
	}
	...
	*/
	public void close(String closeNotes, Technician closer)
	{
		...
		addUpdateNotes("Ticket Closed", closer);
	}
	...
	public void reassignTo(Technician t) 
	{
		...
		this.owner = t;
		t.addTicket(this);
		addUpdateNotes("The ticket has been re-assigned", t);
	}
	...
	/**
	* Gets the technotes as an array list (as opposed to
	* a single printable string).
	* @return An ArrayList of tech notes
	*/
	...
	/**
	* Gets the updatenotes as an array list (as opposed to
	* a single printable string).
	* @return An ArrayList of update notes
	*/
	...
	/**
	 * Helper function to return a string with the tech notes (one on each line).
	 * @return A string with the tech notes (one on each line). 
	 */
	 ...
	 * Close if open and open if closed
	 */
